class MenusController < ApplicationController
  ...
  def create
    ...
    if current_user.get_difference.to_f >= @menu.get_calories.to_f
      ...
      redirect_to recipe,  alert: 'Рецепт не добавлен в меню! Слишком много калорий! Задумайтесь о том, чтобы изменить меню или пейте больше воды. Вода утоляет ложное чувство голода.' 
    end
  end
